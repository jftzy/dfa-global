...
class ReportsController extends Controller
{
    public function statsLoad() {
        ...
        $data = DB::select('
                        select c.name as country, a.title, a.month, a.year, a.quarter, a.project_type, a.project_classification, a.foreign_policy_pillar, a.target_audience, a.strategic_plan, a.diplomacy, a.cultural_domains, a.attached_file
