<x-app-layout>
	...
	<div class="w-full flex flex-col p-6" x-data="options">
		<div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row">
		    <img class="object-cover w-full rounded-t-lg h-52 w-56 md:rounded-none md:rounded-s-lg" src="{{ ENV('APP_URL')}}/imgs/data-analysis.jpg" alt="">
		...
		<div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg mt-4 shadow md:flex-row transition ease-in-out delay-150" :class="upload_form ? 'opacity-100 translate-y-1' : 'opacity-0 -translate-y-14 z-[-999]' ">
